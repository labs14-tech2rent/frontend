        ...
        <div className="footer-content">
            ...
            <div className="footer-content__left">
                ...
                <div className="padding-l-40">
                    ...
                    <a href="#" className="footer-link">Camera Listing</a>
                    <a href="#" className="footer-link">Lens Rental</a>
                    <a href="#" className="footer-link">Canon EOS Rental</a>
                    <a href="#" className="footer-link">Sony Rental</a>
                    <a href="#" className="footer-link">VR Tech</a>
                    <a href="#" className="footer-link">Apple Products Rental</a>
                </div>
            </div>
